...
function Projects() {
  ...
  return (
    ...
    >
      <motion.div 
        className="w-full p-5 lg:p-10 bg-gray-900/40 backdrop-blur-md rounded-2xl shadow-xl flex flex-col items-center justify-center gap-10"
      ...
      >
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-full max-w-7xl cursor-pointer ">
